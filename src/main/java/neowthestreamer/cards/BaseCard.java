...
import neowthestreamer.util.TriFunction;
...
import static neowthestreamer.util.GeneralUtils.removePrefix;
import static neowthestreamer.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return NeowTheStreamer.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    NeowTheStreamer.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
