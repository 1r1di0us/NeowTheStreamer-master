...
public class NeowTheStreamerReward {
    ...
    private NeowTheStreamerOptionDef getRandomOption(int category) {
        ...
        switch (category) {
            case 0:
                int optionIndex = NeowTheStreamerEvent.rng.random(0, 7);
                switch (optionIndex) {
                    case 0:
                ...
                break;
            case 1:
                int challengeIndex = NeowTheStreamerEvent.rng.random(0, 7);
                switch (challengeIndex) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        option.challengeType = NeowTheStreamerChallengeType.FLOORS_CLIMBED_HITLESS;
                        option.challengeDesc = CHALLENGE_TEXT[4];
                        break;
                    case 3:
                        option.challengeType = NeowTheStreamerChallengeType.POTIONS_DISCARDED;
                        option.challengeDesc = CHALLENGE_TEXT[5];
                        break;
                    case 4:
                        option.challengeType = NeowTheStreamerChallengeType.KEYS_OBTAINED;
                        option.challengeDesc = CHALLENGE_TEXT[6];
                        break;
                    case 5:
                        option.challengeType = NeowTheStreamerChallengeType.GOLD_HELD;
                        option.challengeDesc = CHALLENGE_TEXT[7];
                        break;
                    case 6:
                        option.challengeType = NeowTheStreamerChallengeType.CARDS_IN_DECK;
                        option.challengeDesc = CHALLENGE_TEXT[8];
                        break;
                    case 7:
                        //curses.add(NeowTheStreamer.getCurseCard(NeowTheStreamerEvent.rng));
                        curses.add(cardReward = new Parasite()); //placeholder
                        option.challengeType = NeowTheStreamerChallengeType.CURSED_CHALLENGE;
                ...
                int rewardIndex = NeowTheStreamerEvent.rng.random(0, 7);
                switch (rewardIndex) {
                    case 0:
                ...
                break;
            case 2:
                int gigaOptionIndex = NeowTheStreamerEvent.rng.random(0, 9);
                switch (gigaOptionIndex) {
                    ...
                    case 9:
                        ...
                        switch (AbstractDungeon.player.chosenClass) {
                            case IRONCLAD:
                                wrathIndex = NeowTheStreamerEvent.rng.random(0, 2);
                                if (wrathIndex == 0) {
                            ...
                            case WATCHER:
                                ...
                                break;
                            default:
                                wrathIndex = NeowTheStreamerEvent.rng.random(0, 3);
                                if (wrathIndex == 0) {
                                    option.challengeType = NeowTheStreamerChallengeType.WRATH_OF_IRONCLAD;
                                    option.challengeDesc = CHALLENGE_TEXT[15];
                                } else if (wrathIndex == 1) {
    ...
    public void activate() {
        ...
        switch (this.reward) {
            ...
            case TEN_PERCENT_HP_BONUS:
                ...
                break;
            case TWO_FIFTY_GOLD:
                AbstractDungeon.topLevelEffects.add(new ShowCardAndObtainEffect(this.curses.get(0), Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F));
    ...
    public AbstractCard getCard(AbstractCard.CardRarity rarity) {
        switch (rarity) {
            case RARE:
                return AbstractDungeon.rareCardPool.getRandomCard(NeowTheStreamerEvent.rng);
            case UNCOMMON:
                return AbstractDungeon.uncommonCardPool.getRandomCard(NeowTheStreamerEvent.rng);
            case COMMON:
                return AbstractDungeon.commonCardPool.getRandomCard(NeowTheStreamerEvent.rng);
        }
